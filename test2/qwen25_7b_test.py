# qwen25_7b_test.py  — Qwen/Qwen2.5-7B-Instruct
# -----------------------------------------------------------
...
# 실행 예:
#   python qwen25_7b_test.py                 # 전체 프롬프트 전부
#   python qwen25_7b_test.py --int4          # 4bit 양자화
#   python qwen25_7b_test.py --from_file "모델 선정을 위한 테스트.txt"
#   python qwen25_7b_test.py --limit 15
# -----------------------------------------------------------
...
def load_model(model_id, int4):
    ...
    def compat_load(qconfig=None, prefer_fp16=False):
        ...
        try:
            ...
            # 구버전 Transformers 호환: attn_implementation 제거 후 재시도 → 그래도 안 되면 torch_dtype 사용
